...
namespace Algorizm
{
	...
	Algorizm::Shortest_PARAM::Shortest_PARAM(int index)
	{
		...
		{
		case 0:
//			KO_90_L_foff=Saitan_KO_90_foff;
//			KO_90_R_foff=Saitan_KO_90_foff;
//			KO_90_L=Saitan_KO_90_L;
//			KO_90_R=Saitan_KO_90_R;
//			KO_90_L_boff=Saitan_KO_90_boff;
//			KO_90_R_boff=Saitan_KO_90_boff;
...
//			KO_90_L_boff=Saitan_KO_90_boff;
//			KO_90_R_boff=Saitan_KO_90_boff;
//			S_Stra=KO_Saitan_Stra;
//			L_Stra=KO_Saitan_Stra;
//			Diag_Stra=S_Diag_Stra;
//			F_Stra=first_Stra;
//			S_WBreak=S_Wall_Break;
//			S_D_WBreak=S_Diag_Wall_Break;

...
//				{
//					cw_R=Front;//右のモータの回転方向の決定
//					cw_L=Front;//左のモータの回転方向の決定
//				}
//				else//後進のとき
//				{
//					cw_R=Back;//右のモータの回転方向の決定
//					cw_L=Back;//左のモータの回転方向の決定
//				}
			...
			duty_R=(duty_R>1) ? 1 : ((duty_R<0) ? 0 : duty_R);
			duty_L=(duty_L>1) ? 1 : ((duty_L<0) ? 0 : duty_L);

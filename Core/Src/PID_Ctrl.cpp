...
//				{
					...
					fb_stra=(now_cm->isSenkai)?1/V_bat/(10*10*10)*(K_senkai_p*enc_error+K_senkai_i*enc_sigma_error+K_senkai_d*enc_delta_error):fb_stra;
					...
					fb_turn=(now_cm->isSenkai)?1/V_bat/(10*10*10)*(K_tu_senkai_p*gy_error+K_tu_senkai_i*gy_sigma_error+K_tu_senkai_d*gy_delta_error):fb_turn;
//				}
			}
